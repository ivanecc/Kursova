...
public class Rezept_Dish extends FragmentActivity   {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        tabSpec.setIndicator("Інгредієнти");
        ...
        */
        ...
        mTabsAdapter.addTab(mTabHost.newTabSpec("rezept").setIndicator("Рецепт"), RezeptFragment.class, null);
        mTabsAdapter.addTab(mTabHost.newTabSpec("ingred").setIndicator("Інгредієнти"), IngredFragments.class, null);
